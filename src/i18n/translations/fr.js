const frJSON = {
  ...
  'Sistema Porcino NextJS Typescript Admin Dashboard':
    "Tableau de bord d'administration de Sistema Porcino React",
  ...
  'Some of the features that make Sistema Porcino one of the best admin templates available today':
    "Certaines des fonctionnalités qui font de Sistema Porcino l'un des meilleurs modèles d'administration disponibles aujourd'hui",
