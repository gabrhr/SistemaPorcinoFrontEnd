...
export function SubtitleForm({subtitle = "", description = "", d2="", children, list = false}) {
    ...
    if(list){
        return (
            <Grid container item xs={12} sm={12} md={12} spacing={3} justifyContent="space-between" marginTop={0} paddingTop={0}>
            <Grid item xs={12} sm={12} md={4} paddingTop={0}>
            ...
            <Grid item xs={12} sm={12} md={7} marginTop={0} paddingTop={0} className="end-content">
                {children}
            </Grid>
            </Grid>
        )
