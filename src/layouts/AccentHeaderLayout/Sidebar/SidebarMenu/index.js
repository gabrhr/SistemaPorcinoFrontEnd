...
import porcicultorItems from './porcicultorItems';
import administradorItems from './administradorItems';
...
function SidebarMenu() {
  ...
  useEffect(() => {
    const initialize = async () => {
      if (user.person.role === 0) setItems(administradorItems);
      if (user.person.role === 1) setItems(porcicultorItems);
    }
    initialize()
  }, []);
